...
In this project, we explored how Natural Language Processing (NLP) and Machine Learning can automate this process. Our goal was to build a system that reads a raw resume and automatically categorizes it into the correct job role (e.g., Engineering, HR, Sales, Information Technology).
...
Cleaning: To ensure our models learned meaningful patterns, we filtered the data to only include job categories that had at least 100 samples. This helped prevent class imbalance issues.
...
2. Install the following libraries:
   ' pip install pandas numpy scikit-learn spacy matplotlib seaborn python -m spacy download en_core_web_sm'
